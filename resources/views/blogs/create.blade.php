                    ...
                    <div class="overflow-x-auto relative shadow-md sm:rounded-lg m-auto">
                        <form action="{{ route('blogs.store') }}" method="POST" class="w-96" style="margin: 0 auto;" enctype="multipart/form-data">
                            ...
                            <div class="mb-6">
                                ...
                                <textarea id="editor" name="text" rows="6" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500 light:bg-gray-700 light:border-gray-600 light:placeholder-gray-400 light:text-white light:focus:ring-blue-500 light:focus:border-blue-500" placeholder="Text..">{{ old('text') }}</textarea>
                                @error('text')
