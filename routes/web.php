...
Route::middleware('auth')->group(function() {
    ...
    Route::resource('/career', CareersController::class)->except('show');
    Route::get('/contacts', function() { return view('contacts.index'); })->name('default.contact.index');
    ...
    Route::resource('/banners', BannerImagesController::class)->except('show');
});